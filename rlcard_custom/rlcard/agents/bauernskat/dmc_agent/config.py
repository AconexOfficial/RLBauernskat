'''
    File name: rlcard/games/bauernskat/dmc_agent/config.py
...
class TrainerConfig:
    ...
    xpid: str = 'dmc_agent_bauernskat_v1'
    savedir: str = 'experiments/dmc_agent_result'
    load_model: bool = True
    save_every_frames: int = 8_192_000
    seed: int = 21000

    # Logging
    log_to_tensorboard: bool = True
    log_p0_p1_payoffs: bool = True
    log_every_frames: int = 16_384
    ...
    num_actors: int = 10
    num_threads: int = 2
    actor_queue_size_multiplier: int = 256
    ...
    lr_gamma: float = 0.99999424355383592644
    weight_decay: float = 1e-7
    cosine_T0: int = 51_200_000
    cosine_T_mult: int = 2
    cosine_eta_min: float = 3e-5
    batch_size: int = 2_048
    gamma: float = 1.0
    replay_buffer_size: int = 16_384
    ...
    epsilon_decay_type: Literal['linear', 'exponential'] = 'exponential'
    epsilon_gamma: float = 0.99999997751381775046
